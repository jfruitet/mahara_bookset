...
{foreach from=$booksets.data item=bookset}
    <div class="{cycle values='r0,r1'} listrow">
            <h3 class="title"><a href="{$WWWROOT}artefact/bookset/viewlist.php?id={$bookset->id}">{$bookset->title}</a></h3>
 
            <div class="fr booksetstatus">
                <a href="{$WWWROOT}artefact/bookset/select/index.php?id={$bookset->id}" title="{str tag=select}" >
